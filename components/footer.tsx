        ...
        <div className="flex flex-col items-center justify-between space-y-8 md:flex-row md:space-y-0">
            ...
            {[ 
              ...
              >
                {text.startsWith('Phone:') ? (
                  <>Phone: <a href="tel:+918219484765" className="hover:underline hover:text-primary transition-colors duration-300">+918219484765</a></>
                ) : text.startsWith('Email:') ? (
                  <>Email: <a href="mailto:shivarora0069@gmail.com" className="hover:underline hover:text-primary transition-colors duration-300">shivarora0069@gmail.com</a></>
                ) : text}
              </p>
            ))}
          </div>
          <div className="flex flex-col items-center space-y-4">
            <div className="flex space-x-4">
              {[ 
                { icon: Github, href: "https://github.com/ShivArora-Sykkuno", color: "text-purple-500" },
                { icon: Linkedin, href: "https://www.linkedin.com/in/shiv-arora-6038a1200/", color: "text-blue-500" },
                { icon: IoLogoInstagram, href: "https://www.instagram.com/stoned.irl/", color: "text-sky-500" },
                { icon: Mail, href: "mailto:shivarora0069@gmail.com", color: "text-red-500" },
                { icon: SiLeetcode, href: "https://leetcode.com/u/Shiv-Sykkuno/", color: "text-green-500" }
              ].map((social, index) => (
                <Button
                  key={index}
                  variant="ghost"
